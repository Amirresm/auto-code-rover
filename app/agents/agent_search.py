...
SELECT_PROMPT_ARISE = (
    ...
    "Note that the root_dir argument in the APIs below should be relative to the repository root directory. For example, if the repository root directory is /home/user/repo, and the file you want to search is /home/user/repo/src/mypackage/utils.py, then the file_path argument should be src/mypackage/utils.py."
