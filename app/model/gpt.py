...
class Gpt5_4_nano_2026_03_17(OpenaiModelGPT5):
    def __init__(self):
        super().__init__("gpt-5.4-nano-2026-03-17", 16384, 0.0000002, 0.00000125)


class Gpt5_4_mini_2026_03_17(OpenaiModelGPT5):
    def __init__(self):
        super().__init__("gpt-5.4-mini-2026-03-17", 16384, 0.00000075, 0.0000045)
